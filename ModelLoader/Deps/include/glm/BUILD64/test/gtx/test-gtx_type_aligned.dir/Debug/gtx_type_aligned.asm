...
CONST	SEGMENT
$SG49928 DB	'mat4(', 0aH, 00H
	ORG $+1
$SG49929 DB	09H, 'vec4(%2.9f, %2.9f, %2.9f, %2.9f)', 0aH, 00H
	ORG $+5
$SG49930 DB	09H, 'vec4(%2.9f, %2.9f, %2.9f, %2.9f)', 0aH, 00H
	ORG $+5
$SG49931 DB	09H, 'vec4(%2.9f, %2.9f, %2.9f, %2.9f)', 0aH, 00H
	ORG $+5
$SG49932 DB	09H, 'vec4(%2.9f, %2.9f, %2.9f, %2.9f))', 0aH, 0aH, 00H
	ORG $+3
$SG48659 DB	'vec4 - Aligned: %d, unaligned: %d', 0aH, 00H
	ORG $+5
$SG48660 DB	'vec3 - Aligned: %d, unaligned: %d', 0aH, 00H
	ORG $+5
$SG48661 DB	'vec4 - Aligned: %d, unaligned: %d', 0aH, 00H
	ORG $+5
$SG48662 DB	'dvec4 - Aligned: %d, unaligned: %d', 0aH, 00H
CONST	ENDS
...
xdata	ENDS
voltbl	SEGMENT
_volmd	DDSymXIndex: 	FLAT:?perf_mul@@YAHXZ
	DD	024H
	DD	0bbH
voltbl	ENDS
CONST	SEGMENT
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\gtx\gtx_type_aligned.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
