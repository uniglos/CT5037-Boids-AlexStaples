...
CONST	SEGMENT
$SG48259 DB	'C', 00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H
	...
	DB	'_', 00H, 'f', 00H, 'u', 00H, 'n', 00H, 'c', 00H, '_', 00H, 'e'
	DB	00H, 'x', 00H, 'p', 00H, 'o', 00H, 'n', 00H, 'e', 00H, 'n', 00H
	DB	't', 00H, 'i', 00H, 'a', 00H, 'l', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
$SG48260 DB	'!', 00H, 'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H
	DB	00H, 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\core\core_func_exponential.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
...
; 81   : 		assert(!Error);
	...
	lea	rdx, OFFSET FLAT:$SG48259
	lea	rcx, OFFSET FLAT:$SG48260
