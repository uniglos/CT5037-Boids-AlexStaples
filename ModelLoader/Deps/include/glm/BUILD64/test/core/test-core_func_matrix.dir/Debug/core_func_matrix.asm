...
xdata	ENDS
voltbl	SEGMENT
_volmd	DDSymXIndex: 	FLAT:?test_inverse_simd@@YAHXZ
	DD	024H
	DD	03c1H
_volmd	DDSymXIndex: 	FLAT:?test_inverse@@YAHXZ
	DD	024H
	DD	038aH
_volmd	DDSymXIndex: 	FLAT:?test_transpose@@YAHXZ
	DD	027H
	DD	0cc7H
_volmd	DDSymXIndex: 	FLAT:?test_outerProduct@@YAHXZ
	DD	024H
	DD	02f0H
_volmd	DDSymXIndex: 	FLAT:?test_matrixCompMult@@YAHXZ
	DD	027H
	DD	0d0fH
voltbl	ENDS
xdata	SEGMENT
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\core\core_func_matrix.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
