...
CONST	SEGMENT
$SG9845	DB	'Visual C++ 10 - 2010', 0aH, 00H
	ORG $+2
$SG9847	DB	'Visual C++ 11 - 2012', 0aH, 00H
	ORG $+2
$SG9849	DB	'Visual C++ 12 - 2013', 0aH, 00H
	ORG $+2
$SG9851	DB	'Visual C++ 14 - 2015', 0aH, 00H
	ORG $+2
$SG9853	DB	'Visual C++ 15 - 201X', 0aH, 00H
	ORG $+2
$SG9855	DB	'Visual C++ version not detected', 0aH, 00H
	ORG $+3
$SG9898	DB	'CUDA', 0aH, 00H
	ORG $+2
$SG9971	DB	'SSSE3 ', 00H
	ORG $+1
$SG9976	DB	0aH, 00H
	ORG $+2
$SG9859	DB	'GCC 4.4', 0aH, 00H
	ORG $+3
$SG9961	DB	'NEON ', 00H
	ORG $+6
$SG9861	DB	'GCC 4.5', 0aH, 00H
	ORG $+7
$SG9863	DB	'GCC 4.6', 0aH, 00H
	ORG $+7
$SG9865	DB	'GCC 4.7', 0aH, 00H
	ORG $+7
$SG9867	DB	'GCC 4.8', 0aH, 00H
	ORG $+7
$SG9869	DB	'GCC 4.9', 0aH, 00H
	ORG $+7
$SG9871	DB	'GCC 5.0', 0aH, 00H
	ORG $+7
$SG9873	DB	'GCC 5.1', 0aH, 00H
	ORG $+7
$SG9875	DB	'GCC 5.2', 0aH, 00H
	ORG $+7
$SG9877	DB	'GCC 5.3', 0aH, 00H
	ORG $+7
$SG9879	DB	'GCC 5.4', 0aH, 00H
	ORG $+7
$SG9881	DB	'GCC 6.0', 0aH, 00H
	ORG $+7
$SG9883	DB	'GCC 6.1', 0aH, 00H
	ORG $+7
$SG9885	DB	'GCC 6.2', 0aH, 00H
	ORG $+7
$SG9887	DB	'GCC 7.0', 0aH, 00H
	ORG $+7
$SG9889	DB	'GCC 7.1', 0aH, 00H
	ORG $+7
$SG9891	DB	'GCC 7.2', 0aH, 00H
	ORG $+7
$SG9893	DB	'GCC 8.0', 0aH, 00H
	ORG $+7
$SG9895	DB	'GCC version not detected', 0aH, 00H
	ORG $+6
$SG9902	DB	'Clang 3.2', 0aH, 00H
	ORG $+5
$SG9904	DB	'Clang 3.3', 0aH, 00H
	ORG $+5
$SG9906	DB	'Clang 3.4', 0aH, 00H
	ORG $+5
$SG9908	DB	'Clang 3.5', 0aH, 00H
	ORG $+5
$SG9910	DB	'Clang 3.6', 0aH, 00H
	ORG $+5
$SG9912	DB	'Clang 3.7', 0aH, 00H
	ORG $+5
$SG9914	DB	'Clang 3.8', 0aH, 00H
	ORG $+5
$SG9916	DB	'Clang 3.9', 0aH, 00H
	ORG $+5
$SG9918	DB	'Clang 4.0', 0aH, 00H
	ORG $+5
$SG9920	DB	'Clang 4.1', 0aH, 00H
	ORG $+5
$SG9922	DB	'Clang 4.2', 0aH, 00H
	ORG $+5
$SG9924	DB	'LLVM version not detected', 0aH, 00H
	ORG $+5
$SG9928	DB	'ICC 12', 0aH, 00H
$SG9930	DB	'ICC 12.1', 0aH, 00H
	ORG $+6
$SG9932	DB	'ICC 13', 0aH, 00H
$SG9934	DB	'ICC 14', 0aH, 00H
$SG9936	DB	'ICC 15', 0aH, 00H
$SG9938	DB	'ICC 16', 0aH, 00H
$SG9940	DB	'Intel compiler version not detected', 0aH, 00H
	ORG $+3
$SG9941	DB	'Undetected compiler', 0aH, 00H
	ORG $+3
$SG9949	DB	'GLM_MODEL_32', 0aH, 00H
	ORG $+2
$SG9951	DB	'GLM_MODEL_64', 0aH, 00H
	ORG $+2
$SG9955	DB	'GLM_ARCH: ', 00H
	ORG $+5
$SG9957	DB	'GLM_ARCH_PURE ', 00H
	ORG $+1
$SG9959	DB	'ARM ', 00H
	ORG $+3
$SG9963	DB	'AVX2 ', 00H
...
$SG9965	DB	'AVX ', 00H
	ORG $+3
$SG9967	DB	'SSE4.2 ', 00H
$SG9969	DB	'SSE4.1 ', 00H
$SG9973	DB	'SSE3 ', 00H
	ORG $+2
$SG9975	DB	'SSE2 ', 00H
	ORG $+2
$SG9980	DB	'__cplusplus: %d', 0aH, 00H
CONST	ENDS
...
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\core\core_setup_message.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
