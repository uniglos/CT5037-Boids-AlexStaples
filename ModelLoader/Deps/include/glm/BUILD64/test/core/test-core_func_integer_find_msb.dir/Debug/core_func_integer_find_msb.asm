...
_BSS	ENDS
CONST	SEGMENT
$SG5550	DB	'Error for x = %08x, got %d', 0aH, 00H
CONST	ENDS
...
_DATA	ENDS
voltbl	SEGMENT
_volmd	DDSymXIndex: 	FLAT:?nlz7@@YAHI@Z
	DD	028H
	DD	084H
_volmd	DDSymXIndex: 	FLAT:?nlz6@@YAHI@Z
	DD	028H
	DD	078H
voltbl	ENDS
CONST	SEGMENT
...
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\core\core_func_integer_find_msb.cpp
_TEXT	SEGMENT
main	PROC
