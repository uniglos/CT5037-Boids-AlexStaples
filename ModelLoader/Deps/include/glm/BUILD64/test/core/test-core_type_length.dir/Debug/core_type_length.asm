...
xdata	ENDS
voltbl	SEGMENT
_volmd	DDSymXIndex: 	FLAT:?test_length_mat@@YAHXZ
	DD	013H
	DD	0336H
_volmd	DDSymXIndex: 	FLAT:?test_length_mat_non_squared@@YAHXZ
	DD	013H
	DD	0333H
voltbl	ENDS
xdata	SEGMENT
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\core\core_type_length.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
