...
$SG66905 DB	'false', 00H
	ORG $+2
$SG72680 DB	'invalid argument', 00H
	ORG $+3
$SG72681 DB	'%s', 00H
	ORG $+1
$SG72685 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG72682 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30037\include\xmemory', 00H
	ORG $+8
$SG72683 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG72684 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
...
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\core\core_setup_precision.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
