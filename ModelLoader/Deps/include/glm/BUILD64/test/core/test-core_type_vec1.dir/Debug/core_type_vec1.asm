...
CONST	SEGMENT
$SG58142 DB	'C', 00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H
	...
	DB	00H, 'e', 00H, 'c', 00H, '1', 00H, '.', 00H, 'c', 00H, 'p', 00H
	DB	'p', 00H, 00H, 00H
	ORG $+6
$SG58143 DB	'v', 00H, '.', 00H, 'l', 00H, 'e', 00H, 'n', 00H, 'g', 00H
...
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\core\core_type_vec1.cpp
_TEXT	SEGMENT
Error$ = 32
v$ = 52
main	PROC
...
; 144  : 	assert(v.length() == 1);
	...
	lea	rdx, OFFSET FLAT:$SG58142
	lea	rcx, OFFSET FLAT:$SG58143
