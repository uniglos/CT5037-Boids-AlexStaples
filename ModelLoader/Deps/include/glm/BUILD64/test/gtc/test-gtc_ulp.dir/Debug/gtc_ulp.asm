...
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\gtc\gtc_ulp.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
...
; 920  :     _NODISCARD static constexpr double(min)() noexcept {
...
; 871  :     _NODISCARD static constexpr float(min)() noexcept {
