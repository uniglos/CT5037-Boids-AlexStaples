...
PUBLIC	??_C@_1JC@BLJIJCAJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAs?$AA4?$AA0?$AA0?$AA2?$AA6@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1JC@BLJIJCAJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAs?$AA4?$AA0?$AA0?$AA2?$AA6@
CONST	SEGMENT
??_C@_1JC@BLJIJCAJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAs?$AA4?$AA0?$AA0?$AA2?$AA6@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H, 'r', 00H
	DB	's', 00H, '\', 00H, 's', 00H, '4', 00H, '0', 00H, '0', 00H, '2'
	DB	00H, '6', 00H, '7', 00H, '5', 00H, '\', 00H, 'D', 00H, 'o', 00H
	DB	'w', 00H, 'n', 00H, 'l', 00H, 'o', 00H, 'a', 00H, 'd', 00H, 's'
	...
	DB	00H, 'r', 00H, 'm', 00H, '.', 00H, 'i', 00H, 'n', 00H, 'l', 00H
	DB	00H, 00H					; `string'
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
xdata	ENDS
voltbl	SEGMENT
_volmd	DDSymXIndex: 	FLAT:?test_translate@@YAHXZ
	DD	024H
	DD	092H
_volmd	DDSymXIndex: 	FLAT:?test_tweakedInfinitePerspective@@YAHXZ
	DD	024H
	DD	0a0H
_volmd	DDSymXIndex: 	FLAT:?test_pick@@YAHXZ
	DD	024H
	DD	0ceH
_volmd	DDSymXIndex: 	FLAT:?test_perspective@@YAHXZ
	DD	024H
	DD	083H
voltbl	ENDS
xdata	SEGMENT
...
; 260  : 		assert(abs(aspect - std::numeric_limits<T>::epsilon()) > static_cast<T>(0));
	...
	lea	rdx, OFFSET FLAT:??_C@_1JC@BLJIJCAJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAs?$AA4?$AA0?$AA0?$AA2?$AA6@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\s4002675\Downloads\glm-0.9.8.5\glm\test\gtc\gtc_matrix_transform.cpp
_TEXT	SEGMENT
Error$ = 32
main	PROC
